...
> 🔍 **Want to go deeper?** This project is *Simple RAG* — the baseline. Explore
> [18 RAG techniques](../../rag-techniques/) (semantic chunking, reranking, fusion,
> HyDE, adaptive and corrective RAG) with animated pipelines and a benchmark
> leaderboard to see which upgrades actually pay off.
